...
- [ ] 13.2b Send the direct-contact message (`docs/disputes/npm-name-dispute.md` §5) to the current publisher and allow three business days, as the npm disputes policy expects a good-faith attempt first; verify the send date is recorded in §6's `<DATE>` placeholder
